const CACHE_NAME = 'cache-v111'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v111',
    'estilos/styles.css?v111',
    'estilos/mediaQueries.css?v111',
    'javascript/script.js?v111',
