...
function updateTimer() {
  const targetDate = new Date("december 21, 2024 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543794155156'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543794155156'; // Número para el primer botón
